...
values (49, 1,
       ...
       (103, 2, 'Fusce consequat. Nulla nisl. Nunc nisl.', '2021-04-03 11:44:04', '2022-01-05 21:01:34', 'Kendricks',
        'Aubert'),
       (25, 2,
       ...
       (31, 2, 'Etiam vel augue. Vestibulum rutrum rutrum neque. Aenean auctor gravida sem.', '2021-11-07 02:25:31',
       ...
       (103, 2, 'Sed ante. Vivamus tortor. Duis mattis egestas metus.', '2022-01-15 03:35:49', '2021-08-19 05:46:11',
        'Fonz', 'Mohandas'),
       (119, 2,
        'Quisque id justo sit amet sapien dignissim vestibulum. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nulla dapibus dolor vel est. Donec odio justo, sollicitudin ut, suscipit a, feugiat et, eros.',
       ...
       (48, 2, 'Etiam vel augue. Vestibulum rutrum rutrum neque. Aenean auctor gravida sem.', '2021-12-28 19:03:27',
       ...
       (68, 2, 'In congue. Etiam justo. Etiam pretium iaculis justo.', '2021-08-30 18:51:16', '2021-04-04 13:02:51',
        'Sky', 'Lindon'),
       (103, 2,
        'Vestibulum quam sapien, varius ut, blandit non, interdum in, ante. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Duis faucibus accumsan odio. Curabitur convallis.',
       ...
       (37, 2, 'Fusce consequat. Nulla nisl. Nunc nisl.', '2021-06-21 12:34:50', '2021-03-09 11:05:09', 'Powell',
        'Winifield'),
       (82, 2, 'Etiam vel augue. Vestibulum rutrum rutrum neque. Aenean auctor gravida sem.', '2021-10-31 08:16:23',
        '2021-03-23 18:55:47', 'Winifield', 'Rolando'),
       (69, 2, 'Sed ante. Vivamus tortor. Duis mattis egestas metus.', '2021-03-29 13:14:38', '2021-03-23 01:58:27',
        'Giordano', 'Averell'),
       (23, 2,
        'Curabitur gravida nisi at nibh. In hac habitasse platea dictumst. Aliquam augue quam, sollicitudin vitae, consectetuer eget, rutrum at, lorem.',
       ...
       (21, 2, 'In congue. Etiam justo. Etiam pretium iaculis justo.', '2021-05-29 06:29:02', '2021-10-13 02:23:19',
        'Germayne', 'Jermayne'),
       (94, 2,
        'Donec diam neque, vestibulum eget, vulputate ut, ultrices vel, augue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Donec pharetra, magna vestibulum aliquet ultrices, erat tortor sollicitudin mi, sit amet lobortis sapien sapien non mi. Integer ac neque.',
       ...
       (93, 2, 'Suspendisse potenti. In eleifend quam a odio. In hac habitasse platea dictumst.', '2021-11-29 14:10:08',
        '2021-12-21 15:41:28', 'Skipp', 'Broderick'),
       (66, 2, 'Nulla ut erat id mauris vulputate elementum. Nullam varius. Nulla facilisi.', '2021-07-18 13:45:38',
       ...
       (33, 2, 'Sed ante. Vivamus tortor. Duis mattis egestas metus.', '2021-08-12 10:07:09', '2021-02-14 00:36:15',
        'Arvy', 'Tymothy'),
...
values ('blue', now(), now(), 'jm', 'jm'),
       ('crimson', now(), now(), 'jm', 'jm'),
       ('fuscia', now(), now(), 'jm', 'jm'),
       ('goldenrod', now(), now(), 'jm', 'jm'),
       ('green', now(), now(), 'jm', 'jm'),
       ('indigo', now(), now(), 'jm', 'jm'),
       ('khaki', now(), now(), 'jm', 'jm'),
       ('maroon', now(), now(), 'jm', 'jm'),
       ('mauv', now(), now(), 'jm', 'jm'),
       ('orange', now(), now(), 'jm', 'jm'),
       ('pink', now(), now(), 'jm', 'jm'),
       ('puce', now(), now(), 'jm', 'jm'),
       ('purple', now(), now(), 'jm', 'jm'),
       ('red', now(), now(), 'jm', 'jm'),
       ('teal', now(), now(), 'jm', 'jm'),
       ('turquoise', now(), now(), 'jm', 'jm'),
       ('violet', now(), now(), 'jm', 'jm'),
       ('yellow', now(), now(), 'jm', 'jm'),
       ('white', now(), now(), 'jm', 'jm')
;
